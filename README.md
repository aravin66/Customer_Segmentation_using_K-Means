...
## 📌 Project Overview
This project implements customer segmentation using the K-Means clustering algorithm on the Mall Customers dataset. The purpose is to group customers based on spending habits and income levels in order to assist businesses in strategic marketing decision-making.
...
- Interpret segmentation results for business use
...
## 📂 Dataset
Mall Customers Dataset (CSV file) with the following features:
- Customer ID
- Gender
- Age
- Annual Income (k$)
